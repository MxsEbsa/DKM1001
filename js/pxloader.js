...
$(window).load(function(e){
	...
	var loadimagens = new Array (
		...
		/*OED*/
		"conteudo/img/castelo_direitaBrilho.gif",
		"conteudo/img/castelo_esquerdoBrilho.gif",
		"conteudo/img/compridoAnim.gif",
		"conteudo/img/crianca_direitaBrilho.gif",
		"conteudo/img/crianca_esquerdaBrilho.gif",
		"conteudo/img/curtoAnim.gif",
		"conteudo/img/emBaixoBrilho.gif",
		"conteudo/img/emCimaBrilho.gif",
		"conteudo/img/bandeira_fina.png",
		"conteudo/img/bandeira_grosso.png",
		"conteudo/img/bgGame1.png",
		"conteudo/img/carrinho.png",
		"conteudo/img/castelo_direita.png",
		"conteudo/img/castelo_esquerdo.png",
		"conteudo/img/comprido.png",
		"conteudo/img/crianca_direita.png",
		"conteudo/img/crianca_esquerda.png",
		"conteudo/img/criancas-game2.png",
		"conteudo/img/curto.png",
		"conteudo/img/emBaixo.png",
		"conteudo/img/emCima.png",
		"conteudo/img/nuvens.png",
		"conteudo/img/parabens.png",
		"conteudo/img/pracha_maior.png",
		"conteudo/img/pracha_menor.png",
		"conteudo/img/salva_vidas_popup.png",
		"conteudo/img/salva-vidas.png",
		"conteudo/img/standUp_longe.png",
		"conteudo/img/standUp_perto.png"
